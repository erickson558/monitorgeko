...
function mgk_build_windows_ssh_command($iisPorts, $servicePorts) {
    ...
    $psCommands = array(
        ...
        "\$cpuUtility=\$null",
        "try{\$utilityCounter=Get-Counter '\\Processor Information(_Total)\\% Processor Utility' -SampleInterval 1 -MaxSamples 2 -ErrorAction Stop; \$uSamples=@(\$utilityCounter.CounterSamples); if(\$uSamples.Count -gt 0){\$cpuUtility=[double]\$uSamples[\$uSamples.Count-1].CookedValue}}catch{}",
